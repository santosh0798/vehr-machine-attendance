...
const AbsenteesReport = () => {
    ...
    return (
        <StyledMainCardSalary>
            <AttendanceTopbar name="Absentees Report" search="true" absenteesFilter="true" date="true" weeklyOff="true"/>
                    ...
                    <StyledTable sx={{ minWidth: 650 }} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="center">Absent Type</StyledTableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {orders?.employees?.map((row, index) => (
                                ...
                                >
                                    ...
                                    <TableCell align="center">Absent with Permission</TableCell>
                                </StyledTableRow>
                            ))}
                        </TableBody>
                    </StyledTable>
